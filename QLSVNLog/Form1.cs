...
namespace QLSVNLog
{
    public partial class Form1 : Form
    {
        ...
        private void login_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection("Initial Catalog=QLSVN;Data Source=REALHUNTER;Persist Security Info = True;User ID = sa;Password = duylamasd1995");
            ...
            if (isSuccess)
            {
                Menu menu = new QLSVNLog.Menu(usernameBox.Text, passwordBox.Text, conn);
                menu.Show();
            }
            else
